...
public partial class GeometryTests
{
    ...
    public void Intersection_IntersectsWithinSegment_ReturnsIntersectionPoint()
    {
        ...
        var segment = new LineSegment(new Vector2(0, 2), new Vector2(2, 0));
    ...
    {
        var line = Line.FromSlopeAndIntercept(1, 0); // y = x
        var segment = new LineSegment(new Vector2(5, 3), new Vector2(7, 1));
    ...
    {
        var line = Line.FromSlopeAndIntercept(1, 0); // y = x
        var segment = new LineSegment(new Vector2(0, 1), new Vector2(1, 2)); // y = x + 1
    ...
    public void Intersection_VerticalLineHorizontalSegment_ReturnsIntersectionPoint()
    {
        ...
        var segment = new LineSegment(new Vector2(0, 3), new Vector2(4, 3));
    ...
    public void Intersection_HorizontalLineVerticalSegment_ReturnsIntersectionPoint()
    {
        ...
        var segment = new LineSegment(new Vector2(2, 0), new Vector2(2, 5));
    ...
    {
        var line = Line.FromSlopeAndIntercept(1, 0); // y = x
        var segment = new LineSegment(new Vector2(2, 2), new Vector2(4, 0));
    ...
    public void Intersection_DiagonalLineAndSegment_ReturnsIntersectionPoint()
    {
        ...
        var segment = new LineSegment(new Vector2(0, 0), new Vector2(4, 0));
    ...
    public void Intersection_LineOverlapsSegment_ReturnsNull()
    {
        ...
        var segment = new LineSegment(new Vector2(0, 2), new Vector2(4, 2));
    ...
    {
        var line = Line.FromSlopeAndIntercept(0, 2); // y = 2
        var segment = new LineSegment(new Vector2(1, 0), new Vector2(1, 2));
