...
public class Frame
{
    ...
    [ProtoMember(3)] public List<Ball> Balls { get; set; } = new();
    [ProtoMember(4)] public List<Robot> Robots { get; set; } = new();

    [ProtoMember(5)] public KickedBall? KickedBall { get; set; }

    [ProtoMember(6)] public List<Capability> Capabilities { get; set; } = new();
}