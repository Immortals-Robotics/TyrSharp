...
public sealed class ReadOnlyDebugDb(IDebugDb inner) : IDebugDb
{
    ...
    public IEnumerable<T> QueryWithoutMeta<T>(string module, Timestamp t0, Timestamp t1, string? shardKey = null, int? maxCount = null) where T : struct, Tyr.Common.Debug.IEntry
