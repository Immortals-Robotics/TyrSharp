...
public static class RefereeStateExtensions
{
    ...
    public static bool Our(this State state) => state.Color == Context.Color;
    ...
    public static TeamInfo OurInfo(this State state) =>
        Context.Color == TeamColor.Blue ? state.Gc.Blue : state.Gc.Yellow;

    public static TeamInfo OppInfo(this State state) =>
        Context.Color == TeamColor.Yellow ? state.Gc.Blue : state.Gc.Yellow;
