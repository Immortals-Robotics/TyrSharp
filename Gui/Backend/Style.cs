...
public static class Style
{
    public static void Apply()
    {
        ...
        colors[(int)ImGuiCol.Border] = Color.Grey800.WithAlpha(0.5f);
        colors[(int)ImGuiCol.BorderShadow] = Color.Black.WithAlpha(0.24f);
        colors[(int)ImGuiCol.FrameBg] = Color.Black.WithAlpha(0.25f);
        colors[(int)ImGuiCol.FrameBgHovered] = Color.Grey800.WithAlpha(0.25f);
        ...
        colors[(int)ImGuiCol.Button] = Color.Grey800.WithAlpha(0.7f);
        colors[(int)ImGuiCol.ButtonHovered] = Color.Grey700.WithAlpha(0.7f);
        colors[(int)ImGuiCol.ButtonActive] = Color.Grey900;
        ...
        colors[(int)ImGuiCol.TabSelectedOverline] = Color.Grey700.WithAlpha(0.7f);
